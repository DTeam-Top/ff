...
export const tracePayments = sqliteTable(
  "trace_payments",
  {
    ...
    paymentTs: integer("payment_ts", { mode: "timestamp" }), // payment timestamp, -1 for not paid, 1 for paid
    commissionPaid: integer("commission_paid"), // payment timestamp, -1 for not paid, 1 for paid
  },
  (tracePayments) => ({
